...
function G(L, M)
  return (checkCondition(((L > M) and 1 or 0)) and L) or (M)
end
function H(N, O)
  return (checkCondition(((N > O) and 1 or 0)) and N) or (O)
end
function I(P, Q)
  return (checkCondition(((P > Q) and 1 or 0)) and P) or (Q)
end
exportTable.test_max2 = H
exportTable.test_max1 = I
exportTable.main = E
exportTable.test_max3 = G
exportTable.test_max4 = F
exportTable.memory = A
